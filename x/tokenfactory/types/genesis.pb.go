...
type GenesisState struct {
	...
	SudoAdmins    []string       `protobuf:"bytes,3,rep,name=sudo_admins,json=sudoAdmins,proto3" json:"sudo_admins,omitempty" yaml:"sudo_admins"`
}
...
func (m *GenesisState) GetSudoAdmins() []string {
	if m != nil {
		return m.SudoAdmins
	}
	return nil
...
var fileDescriptor_5749c3f71850298b = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SudoAdmins) > 0 {
		for iNdEx := len(m.SudoAdmins) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintGenesis(dAtA, i, uint64(len(m.SudoAdmins[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
